...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        $permissions = [
            ...
            ['title' => "sub_division_access"],
            ['title' => "sub_division_create"],
            ['title' => "sub_division_edit"],
            ['title' => "sub_division_delete"],
            ['title' => "subDivision_employee_access"],
            ['title' => "subDivision_employee_create"],
            ['title' => "subDivision_employee_show"],
            ['title' => "subDivision_employee_edit"],
            ['title' => "subDivision_employee_delete"],
            ['title' => "subDivision_document_category_access"],
            ['title' => "subDivision_document_category_create"],
            ['title' => "subDivision_document_category_edit"],
            ['title' => "subDivision_document_category_delete"],
            ['title' => "subDivision_document_access"],
            ['title' => "subDivision_document_create"],
            ['title' => "subDivision_document_show"],
            ['title' => "subDivision_document_edit"],
            ['title' => "subDivision_document_delete"],
            ['title' => "contact_message_access"],
            ['title' => "contact_message_delete"],
            ['title' => "smuggling_access"],
            ['title' => "smuggling_create"],
            ['title' => "smuggling_show"],
            ['title' => "smuggling_edit"],
            ['title' => "smuggling_delete"],
            ['title' => 'color_access'],
